...
urlpatterns = [
    ...
    path('api/v1/students/<int:student_id>/paces/', get_student_pace, name='v1-get-student-paces'),
    ...
    path('api/v1/students/<int:student_id>/warnings/', get_student_warnings, name='v1-get-students-warnings'),
