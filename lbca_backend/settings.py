...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-ce1we#%iuy^&e5n2s46svlibetkv2fn23i&$-rzgq&%ii__w&5')
...
# Use DATABASE_URL from Render if available, otherwise fall back to SQLite
