...
@swagger_auto_schema(method='get', responses={200: ClassScheduleSerializer(many=True)})
@api_view(['GET'])
...
@swagger_auto_schema(method='get', responses={200: ClassScheduleSerializer})
@api_view(['GET'])
@permission_classes([IsAuthenticated])
...
@swagger_auto_schema(method='post', request_body=ClassScheduleSerializer)
@api_view(['POST'])
@permission_classes([IsAuthenticated])
...
@swagger_auto_schema(method='put', request_body=ClassScheduleSerializer)
@swagger_auto_schema(method='patch', request_body=ClassScheduleSerializer)
@api_view(['PUT', 'PATCH'])
@permission_classes([IsAuthenticated])
