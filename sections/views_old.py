...
@swagger_auto_schema(method='get', responses={200: SectionSerializer(many=True)})
@api_view(['GET'])
...
@swagger_auto_schema(method='get', responses={200: SectionSerializer})
@api_view(['GET'])
@permission_classes([IsAuthenticated])
...
@swagger_auto_schema(method='post', request_body=SectionSerializer)
@api_view(['POST'])
@permission_classes([IsAuthenticated])
...
@swagger_auto_schema(method='put', request_body=SectionSerializer)
@swagger_auto_schema(method='patch', request_body=SectionSerializer)
@api_view(['PUT', 'PATCH'])
@permission_classes([IsAuthenticated])
