...
@swagger_auto_schema(method='get', responses={200: SchoolYearSerializer(many=True)})
@api_view(['GET'])
...
@swagger_auto_schema(method='get', responses={200: SchoolYearSerializer})
@api_view(['GET'])
@permission_classes([IsAuthenticated])
...
@swagger_auto_schema(method='post', request_body=SchoolYearSerializer)
@api_view(['POST'])
@permission_classes([IsAuthenticated])
...
@swagger_auto_schema(method='put', request_body=SchoolYearSerializer)
@swagger_auto_schema(method='patch', request_body=SchoolYearSerializer)
@api_view(['PUT', 'PATCH'])
@permission_classes([IsAuthenticated])
