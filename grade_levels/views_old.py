...
@swagger_auto_schema(method='get', responses={200: GradeLevelSerializer(many=True)})
@api_view(['GET'])
...
@swagger_auto_schema(method='get', responses={200: GradeLevelSerializer})
@api_view(['GET'])
@permission_classes([IsAuthenticated])
...
@swagger_auto_schema(method='post', request_body=GradeLevelSerializer)
@api_view(['POST'])
@permission_classes([IsAuthenticated])
...
@swagger_auto_schema(method='put', request_body=GradeLevelSerializer)
@swagger_auto_schema(method='patch', request_body=GradeLevelSerializer)
@api_view(['PUT', 'PATCH'])
@permission_classes([IsAuthenticated])
